...
\code{kafka-python} ist ein offiziell unterstützter Klient für Apache Kafka in der Programmiersprache Python und basiert lose auf der offiziellen Java Implementierung des Kafka Klients.\autocite{KafkaPython}
...
\lstinputlisting[language=Python, caption=Code Snippet aus Producer.py, firstline=23, lastline=52]{../python/Producer.py}
